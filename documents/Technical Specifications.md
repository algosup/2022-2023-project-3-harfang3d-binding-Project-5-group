<hr>
<p  align="center"  style="font-weight: bold; font-size: 21px"> ALGOSUP bindings project </p>
...
- [Further considerations](#further-considerations)
    - [Impact on other team](#impact-on-other-teams)
...
The ALGOSUP bindings is a project asked by the company Harfang3D[^harfang].
...
Here an example of the final result in the other languages:

The code given with the API result:
<img src="img/python.png">

The Lua code generate by FABGen with the API result:
<img src="img/lua.png">

The Go code generate by FABGen with the API result:
<img src="img/go.png">
...
[^gpl]: GPLV3 is a licence that allow users to use the software for any purpose, to change it to suit the needs, to share the software with their friends and neighbors with or without changes.