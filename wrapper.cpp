...
// return the typetag of a userdata object, null ptr if not a FABGen object
...
// int8t_t type tag
static uint32_t type_tag_int8t_t = 0xb1c21a11;
...
size_t gen_link_binding(gen_type_info *(*get_c_type_info)(const char *type)) {
    ...
    gen_type_info *gen_get_type_info(uint32_t type_tag) {
        return nullptr;
    }
...
int  my_testreturn_int;(){
	auto ret = return_int();
return ret;
}
float  my_testreturn_float;(){
	auto ret = return_float();
return ret;
}
const char * my_testreturn_const_char_ptr;(){
	auto ret = return_const_char_ptr();
return (const char *)ret;
}
int * my_testreturn_int_by_pointer;(){
	auto ret = return_int_by_pointer();
return ret;
}
int * my_testreturn_int_by_reference;(){
	auto ret = &return_int_by_reference();
return ret;
}
int  my_testadd_int_by_value;(int  a; ,int  b;){
	auto ret = add_int_by_value(a,b);
return ret;
}
int  my_testadd_int_by_pointer;(int * a; ,int * b;){
	auto ret = add_int_by_pointer(a,b);
return ret;
}
int  my_testadd_int_by_reference;(int * a; ,int * b;){
